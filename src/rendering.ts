/**
 * Rendering utilities: formatting functions and agent progress renderer.
 */
...
/** Render a single agent result as a TUI container with progress, tools, and output. */
